    ...
    with torch.no_grad():
        ...
        for i, data in enumerate(test_loader):
            ...
            for j in range(y.size(0)):
                ...
                #axes[0,0].plot(outer_contour[:, 1], outer_contour[:, 0], color='white', linewidth=1)
                ...
                axes[0,1].plot(outer_contour[:, 1], outer_contour[:, 0], color='white', linewidth=1)
                ...
                axes[1,0].plot(outer_contour[:, 1], outer_contour[:, 0], color='white', linewidth=1)
                ...
                axes[1,1].plot(outer_contour[:, 1], outer_contour[:, 0], color='white', linewidth=1)
                ...
                # plt.savefig(f'/home/jjwhit/rcGAN/mass_map_utils/notebooks/masked_avg_err_std_{fig_count}.png', bbox_inches='tight', dpi=300)
                # #plt.savefig(f'/share/gpu0/jjwhit/plots/cosmos_training_plots/masked_avg_err_std_{fig_count}.png', bbox_inches='tight', dpi=300)
                # plt.close(fig)
